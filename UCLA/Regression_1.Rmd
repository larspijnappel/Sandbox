...
### Extra: comparison of insulin observations before & after preprocessing
Remember that for several variables, such as `insulin`, the value '0' for an observation has been replaced with 'NA'.
