...
It appears that the file has 4 columns:
```{r}
names(andy)
```
...
This tells us that we have 30 rows of data in 4 columns. There are some other commands we might want to run to get a feel for a new data file, `str()`, `summary()`, and `names() > already applied, see above`.
...
##Performing calculations with incomplete data
...
[PA1]: https://github.com/derekfranks/practice_assignment 'practice_assignment'
