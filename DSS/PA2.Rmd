...
*If you want to follow this tutorial step-by-step in your own Rmd file, then make sure that you include the next two functions as well. These functions are taken from the [Coursera Data Science Specialization][cdss].*
