...
3. [Solution 3 - lapply & do.call / tidyr & dplyr / by & tapply](#solution-3)
...
## Solution 3
> Using lapply & do.call / tidyr & dplyr / by & tapply (and other base functions)
...
### Functions by & tapply and other base functions
...
```{r}
## function by() & tapply() only works because the numeric columns 'sulfate' & 'nitrate' (of the 'dat' df) have been converted to the factor column 'pollutant' in the df 'dat_tidy'.
